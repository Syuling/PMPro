...
from engine.datasets.benchmark import read_split, read_imagenet_split,save_split, split_trainval, Benchmark
...
class ImageNet(Benchmark):
    ...
    def __init__(self, data_dir):
        ...
        train, val, test = read_imagenet_split(self.split_path, self.image_dir)
